...
[TestClass]
public sealed class MyersBitParallel64Tests
{
    ...
    {
        using MyersPattern64 pat = Engine.Prepare(a);
    ...
    {
        using MyersPattern64 pat = Engine.Prepare("");
    ...
    public void Prepare_Allows_Pattern_Of_Exactly_64_Chars()
    {
        ...
        using MyersPattern64 pat = Engine.Prepare(pattern);
    ...
    [TestMethod]
    public void AsciiCaseInsensitive_Default_Folds_Ascii_Letters()
    {
        Assert.AreEqual(0, MyersBitParallel64.AsciiCaseInsensitive.Distance("Hello", "HELLO"));
        Assert.AreEqual(0, MyersBitParallel64.AsciiCaseInsensitive.Distance("KITTEN", "kitten"));
        Assert.AreEqual(1, MyersBitParallel64.AsciiCaseInsensitive.Distance("Hello", "hella"));
    }

    [TestMethod]
    public void AsciiCaseSensitive_Distinguishes_Letter_Case()
    {
        Assert.AreEqual(1, MyersBitParallel64.AsciiCaseSensitive.Distance("Hello", "hello"));
        Assert.AreEqual(5, MyersBitParallel64.AsciiCaseSensitive.Distance("HELLO", "hello"));
        Assert.AreEqual(0, MyersBitParallel64.AsciiCaseSensitive.Distance("HELLO", "HELLO"));
    }

    [TestMethod]
    public void Pattern_Can_Be_Reused_Across_Many_Candidates()
    {
        using MyersPattern64 pat = Engine.Prepare("HELLO");
    ...
    public void BuildCharMask_Matches_Prepared_Pattern_CharMask()
    {
        ...
        using MyersPattern64 pat = Engine.Prepare(sample);
    ...
    public void RequiredCharMask_Rejects_Candidate_Missing_Required_Symbol()
    {
        ...
        using MyersPattern64 pat = Engine.Prepare("QUEEN");
